...
const QColor ChartPlot::baseColors[numColors] = {
    QColor(60,60,255), //blue
    QColor(255,33,47), //red
    QColor(116,255,0), // green
    QColor(234,38,107), //magenta
    QColor(92,255,255), //cyan
    QColor(151,59,239), //mauve
    QColor(231,150,28), // orange
    QColor(231,0,255), // red
};
    ...
    zoomerWidth(2.0f)
{
    ...
    ///> Color map for plots, includes 8 colors
    ///> Map will start from beginning when the first 8 colors are exceeded
